...
const AuthorSection: React.FC = () => {
  return (
    <section id="author" className="section-container bg-gradient-to-b from-neuro-mid to-neuro-dark">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative animated-border p-1 rounded-xl overflow-hidden">
              <img 
                src="/lovable-uploads/6cd72384-fc81-41ae-8bd3-e457868a064d.png" 
