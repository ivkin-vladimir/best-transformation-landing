...
const descriptions: Record<number, { mind: string; body: string; soul: string }> = {
  1: { mind: 'импульсивный', body: 'одержимый', soul: 'терпеливый' },
  2: { mind: 'ранимый', body: 'скованный', soul: 'жизнеспособный' },
  3: { mind: 'весёлый', body: 'выносливый', soul: 'серьёзный' },
  4: { mind: 'забывчивый', body: 'беспокойный', soul: 'решительный' },
  5: { mind: 'одержимый', body: 'стремительный', soul: 'осторожный' },
  6: { mind: 'мягкий', body: 'нежный', soul: 'перфекционист — вы чувствуете любое несовершенство' },
