    ...
    <section id="personality-test" className="section-container bg-gradient-to-b from-neuro-mid to-neuro-dark">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="mt-4">Конечно, такой выбор не является диагностикой, это всего лишь визуальное приключение, первое впечатление при знакомстве с методом, с его необычным предназначением.</p>
          <p>Правильное тестирование производится с помощью фигурок B.E.S.T. оффлайн, при непосредственном прикосновении к ним (вживую). И от вас потребуется совсем другой выбор. Главное условие – ваша спонтанность при выборе фигурок, поэтому заранее не раскрываю, что нужно делать. Приходите и узнавайте себя заново. Ваше вдохновение откроет новую жизнь.</p>
          <p>Метод психопунктура раскрывает полную структуру вашей личности для того, чтобы убрать всевозможные проблемы на уровне тела и ума, реализовать весь потенциал личности.</p>
          <p>Вопросы пишите по адресу <a href="mailto:vladimir@ivkin.me" className="text-primary underline hover:text-primary/80 transition-colors">vladimir@ivkin.me</a>.</p>
        </motion.div>
